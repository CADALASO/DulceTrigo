...
import CatPasabocas from '../../components/catalogo/CatPasabocas';
...
function Pasabocas() {
    ...
    const url = "http://localhost:5000/catalogo?tipo_like=pasabocas";
    ...
    return (
        <div>
            <Navbar />
            <Header />
            <h2 className='title-page'>Pasabocas</h2>
